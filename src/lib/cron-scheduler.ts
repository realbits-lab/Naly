...
export class CronScheduler {
	...
	private async executeMarketAnalysis(job: {
		id: string;
		name: string;
	}): Promise<string> {
	...
	private async executePortfolioUpdate(job: {
		id: string;
		name: string;
	}): Promise<string> {
	...
	private async executePredictionRefresh(job: {
		id: string;
		name: string;
	}): Promise<string> {
	...
	private async executeDataSync(job: {
		id: string;
		name: string;
	}): Promise<string> {
	...
	private async executeCustomTask(job: {
		id: string;
		name: string;
		taskConfig?: Record<string, unknown>;
	}): Promise<string> {
