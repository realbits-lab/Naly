...
import { checkServiceHealth, initializeServices, createServiceConfiguration } from '@/lib/service-registry'
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(createErrorResponse(healthError, requestId), { status: 503 })
  }
}
