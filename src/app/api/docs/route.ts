...
export async function GET(request: NextRequest) {
  ...
  const apiDocumentation = {
    info: {
      ...
      version: '1.0.0',
      description: 'Comprehensive financial intelligence platform providing AI-powered market analysis, predictions, and institutional-grade analytics',
      contact: {
    ...
    endpoints: {
      public: {
        ...
        'AI Narratives': {
          baseUrl: '/api/public/narratives',
          description: 'AI-generated market analysis and insights',
          methods: ['GET', 'POST'],
          examples: [
            {
              title: 'Get Market Narratives',
              url: '/api/public/narratives?ticker=TSLA&category=market_analysis&limit=5',
              description: 'Get AI-generated analysis for specific stocks'
            },
            {
              title: 'Generate Custom Narrative',
              method: 'POST',
              url: '/api/public/narratives',
              body: {
                ticker: 'AAPL',
              ...
              description: 'Generate custom analysis with specific parameters'
            }
          ],
          parameters: {
            ticker: {
            ...
            category: {
              type: 'string',
              enum: ['market_analysis', 'company_deep_dive', 'earnings', 'technical_analysis', 'sector_overview'],
        ...
        'AI Predictions': {
          ...
          examples: [
            ...
            },
            {
              ...
              description: 'Generate custom predictions with specific model parameters'
            }
          ],
          parameters: {
            ticker: {
      ...
      b2b: {
        'Portfolio Analytics': {
          ...
          description: 'Institutional-grade portfolio analysis and risk management',
          ...
          examples: [
            {
              ...
              description: 'Comprehensive risk analysis for institutional portfolios'
            },
            {
          ...
          parameters: {
            endpoint: {
              type: 'string',
              enum: ['portfolio', 'risk', 'performance', 'allocation', 'factor-analysis', 'stress-test'],
...
`
    ...
    errorCodes: {
      ...
      401: {
        ...
        resolution: 'Provide valid API key in X-API-Key header or Authorization: Bearer <key>'
      },
      403: {
        code: 'FORBIDDEN',
