...
const MOCK_FINANCIAL_NEWS: NewsArticle[] = [
	{
		...
		summary:
			"The Federal Reserve indicated today that it may consider cutting interest rates in the coming months as economic indicators show mixed signals.",
		content:
			"Federal Reserve Chair Jerome Powell suggested during today's press conference that the central bank is closely monitoring economic data and may adjust monetary policy accordingly...",
		source: "Reuters",
	...
	},
	{
		...
		summary:
			"Major technology companies exceeded analyst expectations in their fourth-quarter earnings reports, showing resilience in a challenging market environment.",
		content:
			"Apple, Microsoft, and Google parent Alphabet all reported earnings that surpassed Wall Street estimates, driving tech stocks higher in after-hours trading...",
		source: "MarketWatch",
	...
	},
	{
		...
		summary:
			"Crude oil futures jumped over 4% today following reports of increased tensions in the Middle East and concerns about global supply disruptions.",
		content:
			"Brent crude oil futures rose to $85.50 per barrel, marking the highest level in three months as geopolitical tensions escalate in key oil-producing regions...",
		source: "Bloomberg",
	...
	},
	{
		...
		summary:
			"Federal regulators are increasing oversight of banks' exposure to cryptocurrency and digital assets, potentially impacting sector valuations.",
		content:
			"The Office of the Comptroller of the Currency issued new guidance requiring banks to obtain approval before engaging in certain cryptocurrency activities...",
	...
	},
	{
		...
		summary:
			"EV sales data shows continued growth momentum as charging infrastructure expansion addresses consumer concerns about range anxiety.",
		content:
			"Electric vehicle deliveries increased 28% year-over-year in Q4, with Tesla leading the market but facing increased competition from traditional automakers...",
		source: "CNBC",
	...
	},
	{
		...
		summary:
			"Latest Consumer Price Index data reveals persistent core inflation despite falling headline numbers, complicating Federal Reserve decisions.",
		content:
			"The CPI rose 3.2% year-over-year in December, with core inflation excluding food and energy remaining elevated at 3.9%...",
	...
	},
	{
		...
		summary:
			"Major semiconductor companies see stock prices rise following industry reports projecting massive growth in AI chip demand through 2025.",
		content:
			"Industry analysts project that AI chip demand will grow by 85% annually over the next two years, benefiting major semiconductor manufacturers...",
		source: "TechCrunch",
	...
	},
	{
		...
		summary:
			"International shipping delays and port congestion continue to affect global manufacturing, raising concerns about economic growth.",
		content:
			"Manufacturing PMI data from key economies shows continued weakness as supply chain bottlenecks persist, affecting production schedules...",
