							...
							<div className="space-y-8">
								<div className="space-y-4">
									...
									<p className="text-xl text-muted-foreground max-w-lg">
										Transform complex financial data into engaging narratives
										with AI-powered insights, interactive visualizations, and
							...
							<div className="space-y-6">
								{features.map((feature, index) => {
									...
									return (
										<Card
											key={index}
											className="border-muted/50 hover:border-bull/20 transition-colors"
										>
									...
									<CardContent className="p-4">
										<div className="flex items-center space-x-3">
											<div className="flex items-center space-x-2">
												...
												<span className="text-sm font-medium text-bull">
													Live
												</span>
											</div>
