...
export function NarrativeGrid({ filters, userId, isAuthenticated }: NarrativeGridProps) {
      ...
      const mockNarratives: Narrative[] = [
        {
          ...
          summary: 'Microsoft\'s cloud platform continues to capture market share as enterprises increasingly adopt AI-powered solutions, driving significant revenue growth.',
          ticker: 'MSFT',
          sentiment: 'bullish',
          confidence: 0.84,
        ...
        {
          id: '2',
          title: 'Tesla Energy Division Shows Promise Despite Auto Sector Headwinds',
          summary: 'While automotive sales face challenges, Tesla\'s energy storage and solar businesses demonstrate strong growth potential and expanding market opportunities.',
          ticker: 'TSLA',
          sentiment: 'neutral',
          confidence: 0.71,
        ...
        {
          id: '3',
          title: 'Federal Reserve Policy Shift Creates Uncertainty for Growth Stocks',
          summary: 'Recent Fed communications suggest potential policy changes that could significantly impact high-growth technology companies and their valuations.',
          ticker: 'QQQ',
          sentiment: 'bearish',
          confidence: 0.77,
        ...
        {
          id: '4',
          title: 'Nvidia\'s Data Center Business Faces New Competitive Pressures',
          summary: 'Emerging competitors and changing market dynamics in the data center space could challenge Nvidia\'s dominant position in AI computing.',
          ticker: 'NVDA',
          sentiment: 'bearish',
          confidence: 0.69,
  ...
  const getSentimentBadge = (sentiment: Narrative['sentiment']) => {
    switch (sentiment) {
      ...
      case 'bearish': return { variant: 'bear' as const, icon: TrendingDown }
      case 'neutral': return { variant: 'neutral' as const, icon: BarChart3 }
      default: return { variant: 'secondary' as const, icon: BarChart3 }
    }
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {narratives.map((narrative) => {
          ...
          return (
            <Card key={narrative.id} className="group hover:shadow-lg transition-all duration-200">
