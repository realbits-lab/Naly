...
export function FeaturedNarratives({ userId }: FeaturedNarrativesProps) {
			...
			const mockNarratives: FeaturedNarrative[] = [
				{
					id: "1",
					title:
						"Apple's AI Revolution: How Machine Learning is Transforming the iPhone Experience",
					summary:
						"Apple's latest AI developments are creating unprecedented value for both consumers and investors, with the company poised to dominate the next generation of mobile computing.",
					ticker: "AAPL",
					sentiment: "bullish",
					confidence: 0.89,
				...
				},
				{
					id: "2",
					title:
						"The Great Tech Rotation: Why Investors are Shifting from Growth to Value",
					summary:
						"A comprehensive analysis of the current market rotation and its implications for tech stocks, traditional value investments, and portfolio allocation strategies.",
					ticker: "QQQ",
					sentiment: "neutral",
					confidence: 0.82,
				...
				},
				{
					id: "3",
					title:
						"Tesla's Energy Business: The Hidden Catalyst for the Next Bull Run",
					summary:
						"While everyone focuses on car sales, Tesla's energy division is quietly becoming a major growth driver with massive implications for the stock price.",
					ticker: "TSLA",
					sentiment: "bullish",
					confidence: 0.76,
	...
	const getSentimentBadge = (sentiment: FeaturedNarrative["sentiment"]) => {
		switch (sentiment) {
			case "bullish":
				return { variant: "bull" as const, label: "Bullish" };
			case "bearish":
				return { variant: "bear" as const, label: "Bearish" };
			case "neutral":
				return { variant: "neutral" as const, label: "Neutral" };
			default:
							...
							<div
								className={cn(
									...
									narrative.sentiment === "bullish"
										? "from-bull/20 to-bull/5"
										: narrative.sentiment === "bearish"
											? "from-bear/20 to-bear/5"
									...
									<div className="space-y-3">
										<div className="flex items-center justify-between">
											...
											{narrative.hasVisualization && (
												<Badge
													variant="outline"
													className="bg-background/80 backdrop-blur-sm border-bull/20"
												>
									...
									<div className="space-y-4">
										...
										<div className="flex items-center justify-between">
											<div className="flex items-center space-x-2">
												<Badge
													variant="outline"
													className="bg-background/80 backdrop-blur-sm font-mono"
												>
													{narrative.ticker}
												</Badge>
												<div
