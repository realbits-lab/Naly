					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
						<div className="space-y-3">
							...
							<p className="text-sm text-muted-foreground">
								AI-powered financial storytelling that transforms market data
						...
						<div className="space-y-3">
							...
							<div className="flex flex-col space-y-2 text-sm">
								<Link
									href="/narratives?category=earnings"
									className="text-muted-foreground hover:text-foreground"
								>
									Earnings Reports
								</Link>
								<Link
									href="/narratives?category=market-movement"
									className="text-muted-foreground hover:text-foreground"
								>
									Market Movements
								</Link>
								<Link
									href="/narratives?category=predictions"
									className="text-muted-foreground hover:text-foreground"
								>
									AI Predictions
								</Link>
								<Link
									href="/narratives?category=analysis"
									className="text-muted-foreground hover:text-foreground"
								>
									Deep Analysis
								</Link>
