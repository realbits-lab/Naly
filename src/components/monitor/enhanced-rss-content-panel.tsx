									...
									{articles.map((article) => {
										...
										return (
											<div
												key={article.id}
												className={cn(
													"p-4 cursor-pointer hover:bg-muted/50 transition-colors duration-150 ease-linear selectable-item",
													selectedArticle?.id === article.id && "selected-item"
												)}
										...
										{isLoadingExtraction ? (
											...
											<div className="flex items-center justify-center h-64">
												<div className="text-center text-muted-foreground max-w-md">
													...
													<p className="text-sm">
														Content will be automatically loaded when you select an article.
													</p>
												</div>
											</div>
										)}
