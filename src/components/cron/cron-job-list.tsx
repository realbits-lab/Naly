								...
								<div className="flex items-start space-x-3">
									...
									<div className="flex-1 min-w-0">
										...
										<div className="flex items-center space-x-4 mt-2 text-sm text-muted-foreground">
											...
											<span>•</span>
											<span>
												Schedule: {formatCronExpression(job.cronExpression)}
											</span>
											<span>•</span>
								...
								<DropdownMenu>
									...
									<DropdownMenuContent align="end" className="w-48">
										...
										{job.status === "PAUSED" && (
											<DropdownMenuItem
												onClick={() =>
													handleAction(job.id, () => onResume(job.id))
												}
											>
										...
										{job.status === "ACTIVE" && (
											<DropdownMenuItem
												onClick={() =>
													handleAction(job.id, () => onPause(job.id))
												}
											>
										...
										{(job.status === "ACTIVE" || job.status === "PAUSED") && (
											<DropdownMenuItem
												onClick={() =>
													handleAction(job.id, () => onStop(job.id))
												}
											>
				...
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							...
							be undone and will also remove all associated execution logs.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
