...
export function ArticleList({ refreshTrigger, onArticleSelect }: ArticleListProps) {
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => onArticleSelect?.(article)}>
            ...
            {Object.entries(groupedArticles).map(([category, categoryArticles]) => (
              <div key={category}>
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-sm text-muted-foreground">({categoryArticles.length} articles)</span>
                </div>
