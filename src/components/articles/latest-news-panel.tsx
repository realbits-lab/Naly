...
export function LatestNewsPanel({
	...
	const handleGenerateFromSelected = () => {
		...
		toast.success(
			`Generating news from ${selectedArticles.size} selected article(s)`,
		);
	};
	...
	const isPartiallySelected =
		selectedArticles.size > 0 && selectedArticles.size < articles.length;
				...
				<div className="flex items-center justify-between">
					...
					<div className="flex items-center space-x-2">
						...
						>
							...
							{isGenerating
								? "Generating..."
								: `Generate from Selected (${selectedArticles.size})`}
						</Button>
					</div>
				</div>
			</CardHeader>
