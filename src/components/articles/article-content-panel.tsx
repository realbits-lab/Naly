    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-muted/20">
        <div className="text-center space-y-4">
          ...
          <div>
            <h3 className="text-lg font-medium text-foreground">Select an Article</h3>
          ...
          <>
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap items-center gap-4 pb-4 border-b border-border">
                <div className="flex items-center text-sm text-muted-foreground">
                  ...
                  <span>{new Date(displayArticle.createdAt).toLocaleDateString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric',
                    hour: '2-digit',
                ...
                {displayArticle.sentiment && (
                  <Badge className={getSentimentColor(displayArticle.sentiment)}>
              ...
              <div className="flex items-center gap-2 mt-4">
                ...
                <Button
                  ...
                  asChild
                >
                  <a href={`/news/${displayArticle.id}`} target="_blank" rel="noopener noreferrer">
            ...
            {displayArticle.content ? (
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    {displayArticle.summary || 'Full content is not available for this article.'}
                  </p>
                  <Button
                    className="mt-4"
                    asChild
                  >
                    <a href={`/news/${displayArticle.id}`}>
                      View Full Article
                    </a>
                  </Button>
                </CardContent>
